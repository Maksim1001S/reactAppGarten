...
const OrderDetailsForm = ({total_price, cart_products}) => {
  ...
  return (
    <form className={s.form} onSubmit={handleSubmit(submit)}>
        ...
        <div className={s.total_price_container}>
            ...
            <p className={s.total_price}>{total_price}<span>$</span></p>
        </div>
        <input type="tel" placeholder='Phone number' name='phone' {...phoneRegister}/>
