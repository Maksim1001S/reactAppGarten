...
import bg_image from "../../assets/discount_bg_image.png";
          ...
          <form className={s.form} onSubmit={handleSubmit(submit)}>
            ...
            <div className={s.form_group}>
              ...
              <input
                type="tel"
                name="phone"
                className={s.form_input_number}
                {...phoneRegister}
              />
            </div>
            <button type="submit" className={s.form_submit_btn}>
              Get a discount
            </button>
          </form>
        ) : (
          <h1 className={s.afterSubmit}>
            You have successfully submitted the data to receive a discount, you
